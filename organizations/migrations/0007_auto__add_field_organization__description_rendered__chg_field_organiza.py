...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization._description_rendered'
        db.add_column(u'organizations_organization', '_description_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Organization.description'
        db.alter_column(u'organizations_organization', 'description', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))

    def backwards(self, orm):
        # Deleting field 'Organization._description_rendered'
        db.delete_column(u'organizations_organization', '_description_rendered')


        # Changing field 'Organization.description'
        db.alter_column(u'organizations_organization', 'description', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True))
