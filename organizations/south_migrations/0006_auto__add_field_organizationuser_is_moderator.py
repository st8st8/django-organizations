...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrganizationUser.is_moderator'
        db.add_column(u'organizations_organizationuser', 'is_moderator',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrganizationUser.is_moderator'
        db.delete_column(u'organizations_organizationuser', 'is_moderator')
